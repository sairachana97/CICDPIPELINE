...
class RiskPredictionUITest(unittest.TestCase):
    def setUp(self):
        ...
        self.ui = Impl_RiskPredictionsWindow()
    
    def test_loadSchemaButton(self):
        """Test the Load Schema button tooltip"""
        self.assertEqual(self.ui.btn_LoadSchema.toolTip(), "Load the schema created in 'Risk' window.")
    ...
    def test_loadModelButton(self):
        ...
        self.assertEqual(self.ui.btn_LoadModel.toolTip(), "Load the model that was trained in 'Risk' window.")
    ...
    def test_widget_stretch(self):
        ...
        self.assertEqual(self.ui.hlayout.itemAt(0).widget(), self.ui.groupBox)
