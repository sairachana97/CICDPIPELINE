...
class ModelUITest(unittest.TestCase):
    def setUp(self):
        ...
        self.ui = Impl_RiskModelWindow()

    def test_groupBox2(self):
        """Test the newly added components of the new group box."""
        self.assertIsInstance(self.ui.btn_SaveModel,QtWidgets.QPushButton)
        self.assertEqual(self.ui.btn_SaveModel.text(), "Save Model")
        self.assertIsInstance(self.ui.btn_TrainNow,QtWidgets.QPushButton)
        self.assertEqual(self.ui.btn_TrainNow.text(), "Train Now")
